  ...
  return (
    <>
      <div className="App">
                        ...
                        {Children.toArray(
                          data.stats.map((stat) => (
                            <li key={stat.stat.name}>
                              {stat?.stat.name} - base stat value:{" "}
                              {stat?.base_stat}
                            </li>
                          ))
                        )}
        ...
        <footer>
          This project was coded by Federica Ferrante and is
          <a href="https://github.com/Rika1509/POKEMONAPI" target="_blank">
            {" "}
            open-sourced on GitHub{" "}
          </a>
          and{" "}
          <a
            href="https://pokemon-react-pokedex-app.netlify.app/"
            target="blank"
          >
            {" "}
            hosted on Netlify
